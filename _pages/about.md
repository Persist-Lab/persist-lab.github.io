...
The website is deployed using [GitHub Pages](https://pages.github.com/) and the source code is available on [GitHub](). Please feel free to reuse this code (making sure to cite the Bedford lab and Drummond lab as the original sources of the lab website template).
